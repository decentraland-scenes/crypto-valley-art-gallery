...
export default {
  ...
  nfts:[
    ...
    {name:'12',link:'https://cryptoart.ai/gallery/detail/AMartinakis/1122', image:'images/12.jpg', transform:{position: new Vector3(52.909,3.2,33.775), rotation: Quaternion.Euler(0,0,180), scale: new Vector3(2.878,2.878,1)}},
    ...
    {name:'7',link:'https://cryptoart.ai/gallery/detail/Marcelo%20Cantu/1064', image:'images/7.jpg', transform:{position: new Vector3(103.679,3.2,14.115), rotation: Quaternion.Euler(360,90,180), scale: new Vector3(2.878,2.878,1)}},
    {name:'13',link:'https://cryptoart.ai/gallery/detail/AMartinakis/1121', image:'images/13.jpg', transform:{position: new Vector3(103.679,3.2,19.105), rotation: Quaternion.Euler(360,90,180), scale: new Vector3(2.878,2.878,1)}},
    {name:'16',link:'https://cryptoart.ai/gallery/detail/Onderwish/1128', image:'images/16.jpg', transform:{position: new Vector3(103.679,3.2,24.145), rotation: Quaternion.Euler(360,90,180), scale: new Vector3(2.878,2.878,1)}},
  ...
  videonfts:[
        
    {
        ...
        transform: new Transform({position: new Vector3(97.949,2.9,33.765), rotation: Quaternion.Euler(360,360,0), scale: new Vector3(2.878,2.878,1)}),
...

      {
        ...
        transform: new Transform({position: new Vector3(105.279,2.9,33.775), rotation: Quaternion.Euler(360,360,360), scale: new Vector3(2.878,2.878,1)}),
        trigger: new utils.TriggerBoxShape(new Vector3(4, 4, 6), new Vector3(0,-0.5, -3)),
        title: "11",
        artist: '',
...

      {
        ...
        transform: new Transform({position: new Vector3(112.599,2.9,33.775), rotation: Quaternion.Euler(360,360,0), scale: new Vector3(2.878,2.878,1)}),
        trigger: new utils.TriggerBoxShape(new Vector3(4, 4, 6), new Vector3(0,-0.5, -3)),
        title: "17",
        artist: '',
...

      {
        ...
        transform: new Transform({position: new Vector3(108.839,2.9,4.215), rotation: Quaternion.Euler(0,180,360), scale: new Vector3(2.878,2.878,1)}),
        trigger: new utils.TriggerBoxShape(new Vector3(4, 4, 6), new Vector3(0,-0.5, 3)),
        title: "10",
        artist: '',
...

      {
        ...
        transform: new Transform({position: new Vector3(101.309,2.9,4.205), rotation: Quaternion.Euler(0,180,360), scale: new Vector3(2.878,2.878,1)}),
        trigger: new utils.TriggerBoxShape(new Vector3(4, 4, 6), new Vector3(0,-0.5, 3)),
        title: "15",
        artist: '',
...

      {
        ...
        transform: new Transform({position: new Vector3(93.749,2.9,4.205), rotation: Quaternion.Euler(0,180,360), scale: new Vector3(2.878,2.878,1)}),
        trigger: new utils.TriggerBoxShape(new Vector3(4, 4, 6), new Vector3(0,-0.5, 3)),
        title: "14",
        artist: '',
...

      {
        ...
        transform: new Transform({position: new Vector3(104.319,2.89,19.165), rotation: Quaternion.Euler(0,270,360), scale: new Vector3(2.878,2.878,1)}),
        trigger: new utils.TriggerBoxShape(new Vector3(6, 4, 4), new Vector3(3,-0.5, 0)),
        title: "2",
        artist: '',
