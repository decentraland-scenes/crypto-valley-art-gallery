...
export default {
  ...
  videonfts:[
        
    {
        ...
        trigger: new utils.TriggerBoxShape(new Vector3(4, 4, 8), new Vector3(0,-0.5, -4)),
        title: "8",
        artist: '',
...

      {
        ...
        transform: new Transform({position: new Vector3(107.839,2.9,4.215), rotation: Quaternion.Euler(0,180,360), scale: new Vector3(5.114,2.878,1)}),
        trigger: new utils.TriggerBoxShape(new Vector3(4, 4, 8), new Vector3(0,-0.5, 4)),
        title: "10",
        artist: '',
...

      {
        ...
        transform: new Transform({position: new Vector3(94.749,2.9,4.205), rotation: Quaternion.Euler(0,180,360), scale: new Vector3(5.114,2.878,1)}),
        trigger: new utils.TriggerBoxShape(new Vector3(4, 4, 8), new Vector3(0,-0.5, 4)),
        title: "14",
        artist: '',
...

      {
        ...
        trigger: new utils.TriggerBoxShape(new Vector3(8, 4, 4), new Vector3(4,-0.5, 0)),
        title: "9",
        artist: '',
