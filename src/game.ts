...
//1
const waveVideoClip = new VideoClip("https://player.vimeo.com/external/570332974.m3u8?s=4ae5758275151cae7c8fb7b3d901a3db81e1b2dc")
...
waveScreen.addComponent(new Transform({position: new Vector3(57.7,4.1,4.3), rotation: Quaternion.Euler(0,0,0), scale: new Vector3(4.6,5.85,4.55)}))
...
//2
const rekodeVideoClip = new VideoClip("https://player.vimeo.com/external/570333036.m3u8?s=7c9ab886923e7e40dabee75718938d5e34992262") //streaming link
...
rekodeScreen.addComponent(new Transform({position: new Vector3(54.8, 4.15, 33.7), rotation: Quaternion.Euler(0,180,0), scale: new Vector3(4.75,5.9,4.5)}))
...
//3 
const dayVideoClip = new VideoClip("https://player.vimeo.com/external/570332821.m3u8?s=8048205c843edc3c81e2bf460805e4a33f1335f1") //streaming link
...
dayScreen.addComponent(new Transform({position: new Vector3(104.3,4,19.1), rotation: Quaternion.Euler(0,90,0), scale: new Vector3(3.2,5.8,3.4)}))
...
//4
const pbsrVideoClip = new VideoClip("https://player.vimeo.com/external/570332927.m3u8?s=cb75c792367b86f7971bc5d0a6afcbf11d25b0d7") //streaming link
...
pbsrScreen.addComponent(new Transform({position: new Vector3(79,5.1,25.7), rotation: Quaternion.Euler(0,0,0), scale: new Vector3(4,6.9,3)}))
...
//5
const mbsjqVideoClip = new VideoClip("https://player.vimeo.com/external/570332881.m3u8?s=446d33847392ef94d603ffe0b77869ac3ae242e0") //streaming link
...
mbsjqScreen.addComponent(new Transform({position: new Vector3(103.71,4,18.88), rotation: Quaternion.Euler(0,-90,0), scale: new Vector3(3.3,6,3.4)}))
...
// Trigger boxes >> causing issues prob. due to migration

//1
//let waveTriggerBox = new utils.TriggerBoxShape(new Vector3(14, 20, 10), new Vector3(57.7,3.8,4.3))
